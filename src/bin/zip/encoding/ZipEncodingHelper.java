...
public abstract class ZipEncodingHelper {
     ...
     * @return A byte buffer {@code r} with
     *         {@code r.capacity() = max(b.capacity()*2,newCapacity)} and
     *         all the data contained in {@code b} copied to the beginning
     *         of {@code r}.
     *
     */
    ...
    /**
     * The hexadecimal digits {@code 0,...,9,A,...,F} encoded as
     * ASCII bytes.
     */
    ...
    /**
     * Append {@code %Uxxxx} to the given byte buffer.
     * The caller must assure, that {@code bb.remaining()&gt;=6}.
     *
